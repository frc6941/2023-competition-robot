...
public class AStarPathPlannerLimitRate {
    ...
    public Path plan(Translation2d startingPoint, Translation2d endingPoint, Obstacle[] obstacles,
            double stepx, double stepy, double hGain, double overtimeLimit, double dt) {
        // Cleanup parameters
        ...
        while (openSet.size() != 0 && timer.get() <= overtimeLimit) {
            ...
            searchNear(minimalNode, endingPoint, obstacles, stepx, stepy, hGain, dt);
            searchNear(minimalNode, endingPoint, obstacles, stepx, -stepy, hGain, dt);
            searchNear(minimalNode, endingPoint, obstacles, -stepx, stepy, hGain, dt);
            searchNear(minimalNode, endingPoint, obstacles, -stepx, -stepy, hGain, dt);
            searchNear(minimalNode, endingPoint, obstacles, stepx, 0, hGain, dt);
            searchNear(minimalNode, endingPoint, obstacles, -stepx, 0, hGain, dt);
            searchNear(minimalNode, endingPoint, obstacles, 0, stepy, hGain, dt);
            searchNear(minimalNode, endingPoint, obstacles, 0, -stepy, hGain, dt);
    ...
    private void searchNear(Node minimalNode, Translation2d destination, Obstacle[] obstacles, double stepx,
            double stepy, double hGain, double dt) {
